...
public class AdapterAllLoans extends RecyclerView.Adapter<AdapterAllLoans.MyViewHolder>{
    private List<Loans> loansList;
    private Context context;

    public AdapterAllLoans(List<Loans>loansList,Context context){
    ...
    @Override
    public AdapterAllLoans.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.loans,parent,false);
        return new AdapterAllLoans.MyViewHolder(view);
    }
